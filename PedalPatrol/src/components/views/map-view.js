	...
	render() {
		...
		return (
				...
				<View style={{ flex: 1 }}>
					...
					<View style={[bbStyle(varTop-map_styles.iconButton.height-35), {marginLeft: 10},map_styles.iconButtonView]}>
					...
					<View style={[bbStyle(varTop-map_styles.iconButton.height*2-37*3), {marginLeft: 10},map_styles.iconButtonView]}>
